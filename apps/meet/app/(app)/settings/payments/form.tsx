...
// 'legal_name_invoices' is Thread's 'legal_name_on_invoices'. A `t(key)` would
...
function strings(locale: Locale) {
  return {
    personalAccount: t(locale, 'pay_my_account'),
    personalAccountDesc: t(locale, 'pay_my_desc'),
    workspaceAccount: t(locale, 'pay_ws_account'),
    workspaceAccountDesc: t(locale, 'pay_ws_desc'),
    methodsHintWorkspace: t(locale, 'pay_methods_hint_ws'),
    methodsHintPersonal: t(locale, 'pay_methods_hint_personal'),
    managedByAdmins: t(locale, 'pay_admin_only'),
    stripeNote1: t(locale, 'pay_footer'),
    ...
    legalName: t(locale, 'legal_name_invoices'),
    taxNumber: t(locale, 'tax_vat_number'),
    address: t(locale, 'address_invoices'),
    vatOnSales: t(locale, 'vat_on_sales'),
    vatRegistered: t(locale, 'vat_registered'),
    rate: t(locale, 'rate'),
    vatIncludedNote: t(locale, 'vat_note'),
