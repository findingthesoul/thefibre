...
import { COOKIE_THEME, COOKIE_TODO, COOKIE_SIDEBAR, COOKIE_LOCALE, COOKIE_WELCOME, COOKIE_LAUNCHER, COOKIE_APPS_SECTION, COOKIE_LAUNCHER_PENDING } from './prefs-shared';

const ONE_YEAR = 60 * 60 * 24 * 365;
const ALLOWED = new Set<string>([COOKIE_TODO, COOKIE_THEME, COOKIE_SIDEBAR, COOKIE_LOCALE, COOKIE_WELCOME, COOKIE_LAUNCHER, COOKIE_APPS_SECTION, COOKIE_LAUNCHER_PENDING]);
