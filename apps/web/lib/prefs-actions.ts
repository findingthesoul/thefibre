...
import { COOKIE_THEME, COOKIE_SIDEBAR, COOKIE_LOCALE, COOKIE_WELCOME } from './prefs-shared';

const ONE_YEAR = 60 * 60 * 24 * 365;
const ALLOWED = new Set<string>([COOKIE_THEME, COOKIE_SIDEBAR, COOKIE_LOCALE, COOKIE_WELCOME]);
