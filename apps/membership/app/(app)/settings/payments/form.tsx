...
export function PaymentsForm({
  ...
  return (
    <div className="mt-8 space-y-10">
      <AccountSection
        label="My account"
        description="Payouts for your personal sales — one connection, every Fibre app uses it. The invoice details appear as the seller on receipts for your personal sales."
      ...
      <AccountSection
        ...
        description="Payouts for team sales and anything routed to the workspace. Teams don't hold their own accounts — team sales land here, with these invoice details as the seller."
        initialAccount={workspaceAccount}
        initialDetails={workspaceDetails}
        initialMethods={workspaceMethods}
        showMethods
        methodsHint="team & workspace sales inherit these"
      ...
      <p className="text-xs text-ink-muted max-w-xl leading-relaxed">
        ...
        downward: account default first, each app can override per item.
      </p>
    </div>
  );
}
          ...
          {showMethods && (
            <div>
              <span className="text-xs text-ink-subtle">
                Default payment options — {methodsHint ?? 'your personal sales inherit these'}
              </span>
