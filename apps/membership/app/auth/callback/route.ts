// Membership auth callback. Members signing in for /my or the OAuth
// continue page are NOT workspace users — no workspace access gate there.
...
export const GET = createAuthCallback({
  ...
  env: process.env,
  publicPrefixes: ['/my', '/oauth-continue'],
});
