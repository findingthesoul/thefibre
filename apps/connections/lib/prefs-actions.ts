...
import { COOKIE_THEME, COOKIE_TODO, COOKIE_SIDEBAR, COOKIE_INTRO } from './prefs-shared';

const ONE_YEAR = 60 * 60 * 24 * 365;
const ALLOWED = new Set<string>([COOKIE_TODO, COOKIE_THEME, COOKIE_SIDEBAR, COOKIE_INTRO]);
