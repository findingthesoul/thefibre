// Connections — signed-in interface translations.
//
// Started as a copy of Pulse's catalog because the shell (sidebar, topbar,
// user menu, settings) reads dozens of its keys and a half-populated catalog
// would fail typecheck on chrome this app did not write. Pulse-only strings
// in here are dead weight and should be pruned once this app's surfaces have
// settled — pruning them now risks breaking shell it shares.
//
// THE RULE: every string a signed-in user can see in Connections' interface lives
...
const CATALOG = {
  ...
  nav_attention: {
    ...
    pt: 'Precisa de ti', // MT
    de: 'Braucht dich', // MT
    fr: 'A besoin de vous', // MT
  },
  landscape_intro: {
    en: 'Where everybody stands, worked out from what has actually happened — who came, who came back, who contributes, who holds space. Nothing here is typed in by hand.',
    nl: 'Waar iedereen staat, afgeleid uit wat er werkelijk gebeurd is — wie kwam, wie terugkwam, wie bijdraagt, wie ruimte houdt. Niets hiervan wordt met de hand ingevoerd.',
    es: 'Dónde está cada persona, deducido de lo que realmente ha pasado: quién vino, quién volvió, quién contribuye, quién sostiene el espacio. Nada de esto se escribe a mano.', // MT
    pt: 'Onde cada pessoa está, deduzido do que aconteceu mesmo — quem veio, quem voltou, quem contribui, quem sustenta o espaço. Nada aqui é escrito à mão.', // MT
    de: 'Wo alle stehen, abgeleitet aus dem, was tatsächlich passiert ist — wer kam, wer wiederkam, wer beiträgt, wer den Raum hält. Nichts davon wird von Hand eingetragen.', // MT
    fr: 'Où chacun se situe, déduit de ce qui s’est réellement passé : qui est venu, qui est revenu, qui contribue, qui tient l’espace. Rien ici n’est saisi à la main.', // MT
  },
  landscape_empty: {
    en: 'No people in this workspace yet.',
    nl: 'Nog geen mensen in deze workspace.',
    es: 'Aún no hay personas en este espacio de trabajo.', // MT
    pt: 'Ainda não há pessoas neste espaço de trabalho.', // MT
    de: 'Noch keine Personen in diesem Workspace.', // MT
    fr: 'Encore personne dans cet espace de travail.', // MT
  },
  landscape_people: {
    en: 'people',
    nl: 'mensen',
  ...
  landscape_movement: {
    ...
    nl: 'Wat er bewoog',
    es: 'Qué se movió', // MT
    pt: 'O que se moveu', // MT
    de: 'Was sich bewegt hat', // MT
    fr: 'Ce qui a bougé', // MT
  },
  landscape_days_short: {
    en: 'd',
    nl: 'd',
    es: 'd', // MT
    pt: 'd', // MT
  ...
  landscape_no_movement: {
    en: 'Nobody moved.',
    nl: 'Niemand bewoog.',
    es: 'Nadie se movió.', // MT
    pt: 'Ninguém se moveu.', // MT
    de: 'Niemand hat sich bewegt.', // MT
    fr: 'Personne n’a bougé.', // MT
  },
  landscape_arrived: {
    en: 'arrived since',
    nl: 'nieuw sindsdien',
    es: 'llegaron desde entonces', // MT
    pt: 'chegaram desde então', // MT
    de: 'seitdem dazugekommen', // MT
    fr: 'arrivés depuis', // MT
  },
  landscape_and_more: {
    en: 'and more:',
    nl: 'en nog:',
  ...
  // The ladder. Plain descriptions of what somebody did, never a judgement
  // about them — see docs/connections-model.md §5 on language.
  rung_facilitator: {
    en: 'Holds space',
    nl: 'Houdt ruimte',
    es: 'Sostiene el espacio', // MT
    pt: 'Sustenta o espaço', // MT
    de: 'Hält den Raum', // MT
    fr: 'Tient l’espace', // MT
  },
  rung_contributor: {
    en: 'Contributes',
    nl: 'Draagt bij',
  ...
  attention_intro: {
    ...
    es: 'Situaciones con nombre, cada una con el hecho que la produjo. Nunca una puntuación: aquí nadie se clasifica.', // MT
    pt: 'Situações com nome, cada uma com o facto que a produziu. Nunca uma pontuação — aqui ninguém é classificado.', // MT
    de: 'Benannte Situationen, jede mit dem Fakt dahinter. Nie eine Punktzahl — hier wird niemand bewertet.', // MT
    fr: 'Des situations nommées, chacune avec le fait qui la produit. Jamais un score : personne n’est classé ici.', // MT
  },
  attention_none: {
    en: 'Nothing is asking for you right now.',
    nl: 'Er vraagt nu niets om je aandacht.',
    es: 'Ahora mismo nada te reclama.', // MT
    pt: 'Neste momento nada precisa de ti.', // MT
    de: 'Gerade braucht dich nichts.', // MT
    fr: 'Rien ne vous réclame pour le moment.', // MT
  },
  cond_went_quiet: {
    en: 'Went quiet',
    nl: 'Werd stil',
    es: 'Se quedó en silencio', // MT
    pt: 'Ficou em silêncio', // MT
    de: 'Ist still geworden', // MT
    fr: 'S’est tu', // MT
  },
  cond_arrived_unattended: {
    en: 'Arrived, nobody followed up',
    nl: 'Kwam binnen, niemand nam contact op',
    es: 'Llegó y nadie dio seguimiento', // MT
    pt: 'Chegou e ninguém deu seguimento', // MT
    de: 'Kam an, niemand hat sich gemeldet', // MT
    fr: 'Arrivé, personne n’a donné suite', // MT
  },
  cond_finished_nothing_next: {
    en: 'Finished, nothing next',
    nl: 'Klaar, niets volgends',
    es: 'Terminó, nada a continuación', // MT
    pt: 'Terminou, nada a seguir', // MT
    de: 'Fertig, nichts Weiteres', // MT
    fr: 'Terminé, rien ensuite', // MT
  },
  cond_ambassador_drifting: {
    en: 'An advocate drifting',
    nl: 'Een ambassadeur die afdrijft',
    es: 'Un defensor que se aleja', // MT
