...
function strings(locale: Locale) {
  return {
    ...
    stripeNote1: t(locale, 'acct_hint_1'),
    stripeNote2: t(locale, 'acct_hint_2'),
    ...
    save: t(locale, 'save'),
    saved: t(locale, 'saved_notice'),
    errAcctPrefix: t(locale, 'acct_starts_error'),
    errKeepOneMethod: t(locale, 'keep_one_method_error'),
