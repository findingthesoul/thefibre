...
// per page tree: any code calls toastError(msg) and a red toast pops
// top-right, above every dialog (dialogs are z-50), auto-dismisses after 6s,
// or dismisses on click. Field-level VALIDATION messages stay inline near
// their field — this is for server/API failures. Extracted from pulse's
