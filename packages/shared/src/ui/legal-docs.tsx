// The legal & help documents, ONE implementation (Sjoerd, 2026-09-08:
// clicking Privacy on thethread.app must not land you on thefibre.app).
// Served by BOTH public surfaces — thefibre.app and thethread.app — under
// the same paths (/terms, /privacy-policy, /support), so internal links
// stay relative and each brand keeps its visitor. Includes the prose kit
// that used to live in apps/web/app/(public)/prose.tsx.

import type { ReactNode } from 'react';
import { ENTITY } from '../branding.js';
    ...
    <>
      ...
      <List>
        ...
        <Item>
          ...
          <a className="underline hover:text-neutral-900" href="/privacy-policy">
            privacy statement
          </a>
          .
        </Item>
  ...
  return (
    <>
      ...
      <P>
        ...
        <a className="underline hover:text-neutral-900" href="/terms">
          terms
        </a>
        .
      </P>
    ...
    <>
      ...
      <List>
        <Item>
          ...
          are joining, or{' '}
          <a className="underline hover:text-neutral-900" href="/request-access">
            request access
          </a>
