...
| 113 | "Today: I like to see the whole day... greyed out what has passed, but still clickable... a line of the time" | **Open** |
| 114 | "When clicking the item... I like to see the popup of What happened, prefilled as stated earlier" | **Open** — the meeting TITLE already opens it (v0.82.0); he is clicking the row |
...
| 116 | "I like that the day selection at the top" | **Open** — move the horizon control above the agenda |
| 117 | The page intro paragraph "should have a toggle button (on and off... reduce info on interface when not really needed)" | **Open** |
