...
| 106 | "If locations of meetings in the agenda are filled in: location → maps... zoom/teams: link opens app" | **Open** |
| 107 | "When click on the meeting, it should open and select the people present and potentially add info immediately (online meeting, date filled in, basic content in the description field like the title). Maybe the meeting is connected to a project or a company" | **Open** |
