-- Grammar, take two. 20260829150000 turned "1 people" into "2 persons", which
-- is not an improvement. The plural of person here is people.
--
-- Behaviour unchanged; this is the sentence a person reads in The Thread when
-- they try to change a message that has already gone out.
...
begin
  ...
  v_who := case when v_sent = 1 then '1 person' else v_sent || ' people' end;
